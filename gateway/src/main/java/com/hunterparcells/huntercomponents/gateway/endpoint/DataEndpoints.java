package com.hunterparcells.huntercomponents.gateway.endpoint;
...
public final class DataEndpoints {
    ...
    private static final long CACHE_DURATION_MS = Long.getLong("HunterComponents.TagCounter.CacheDuration", 30000L);
